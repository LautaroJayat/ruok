...
- [RUOK Scheduler](#ruok-scheduler)
  ...
  - [2. Getting Started](#getting-started)
    ...
    - [2.2 Preparing the Database](#preparing-the-database)
    - [2.3 Starting RUOK Scheduler](#starting-ruok-scheduler)
  - [3. Configurations](#configurations)
    - [3.1 DB user](#db-user)
    - [3.2 DB Password](#db-password)
    - [3.3 DB Host](#db-host)
    - [3.4 DB Port](#db-port)
    - [3.5 DB Name](#db-name)
    - [3.6 Application Name](#application-name)
    - [3.7 SSL Mode](#ssl-mode)
    - [3.8 Client Cert Password](#client-cert-password)
    - [3.9 Polling Interval](#polling-interval)
    - [3.10 Max Number of Jobs](#max-number-of-jobs)
  - [4. Job Configuration](#job-configuration)
  - [5. Cron Specification](#cron-specification)
  - [6. License](#license)
